...
xlabel('$$ {\textbf {\textit 1}}/{{{\mathcal{L}}}({\textit {\textbf j}}\rightarrow {\textit {\textbf i}})}$$','Interpreter','LaTeX','Fontsize',56)
ylabel('${\textbf {\textit 1}}/{\textbf {\textit T}({\textit {\textbf j}}\rightarrow {\textit {\textbf i}})}$','Interpreter','LaTeX','Fontsize',56)
